...
test_api_key_header() {
  ...
  NVD_API_KEY="test-key-abc123" run_download "$test_dir" # gitleaks:allow -- test fixture

  if grep -q 'apiKey: test-key-abc123' "$test_dir/state/full_args.log"; then # gitleaks:allow -- test fixture
